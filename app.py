...
# Add popup container at the top of the page
with st.container():
    st.info("Hi! We've moved to a new website. V2 is cleaner and has more features!")
    st.link_button("Take me there!", "https://ufcrax-v2.vercel.app/", type="primary", use_container_width=True)
